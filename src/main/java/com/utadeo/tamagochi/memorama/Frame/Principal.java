package com.utadeo.tamagochi.memorama.Frame;
...
import com.utadeo.tamagochi.memorama.Methods.Match;
import com.utadeo.tamagochi.memorama.Methods.Utilities;
...
public class Principal extends javax.swing.JFrame {
    ...
    private javax.swing.Timer timerEnergiaPositiva;
    ...
    public Principal() {
        ...
        timerEnergiaPositiva = new javax.swing.Timer(6000, energiaListener);// mil milisegundos
        timerEnergiaPositiva.setInitialDelay(0);
        timerEnergiaPositiva.start();
    }
    
    private void updateEnergia(){
        final TamagochiDAO tamagochiDAO = new TamagochiDAO();
        Tamagochi tamagochi = tamagochiDAO.read(idTamagochi);
        if(tamagochi.getEnergia()!=100){
    ...
    public void setTimerEnergia(Timer timerEnergia) {
        this.timerEnergia = timerEnergia;
    }
